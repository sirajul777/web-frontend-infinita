...
import { Hero, Hero2, Hero3, Hero4 } from "../../public/assets";
    ...
    return (
      <Layout>
        <div id="hero_blog" className="relative">
          <div className="mx-0">
            <Image src={Hero4} layout="responsive" />
          </div>
        </div>
        ...
        <section>
          <div className="container md:px-20 p-5 py-10">
            <div className="grid grid-rows-auto">
              {/* card blog */}
              <h1 className=" font-sans text-4xl p-5 font-bold text-gray-600 text-center">Blog Article</h1>
