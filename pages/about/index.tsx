      ...
      <div id="about_description" className="relative card drop-shadow-lg rounded-md -top-10 bg-white p-10 max-w-max">
        ...
        <div className="grid grid-col-1 md:flex w-auto ">
          <div className="image w-full md:w-[50%] flex">
            <div className="green-card absolute max-w-80 w-1/2 md:w-80 max-h-[30rem] h-[20rem] md:h-[30rem] rounded-md items-start"></div>
            ...
            <div className="bluelight-card opacity-25 max-w-80 w-2/3 md:w-80 max-h-[30rem] h-[22rem] md:h-[30rem] rounded-md items-end md:mt-24 mt-14 ml-auto md:ml-40 "></div>
          </div>
