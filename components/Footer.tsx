        ...
        <div className="bg-amber-100">
          <div className="container md:px-20 px-5 w-full">
            <div className="grid grid-col-1 md:grid-cols-3 md:gap-4">
              <div className="gap-4 p-5 mx-20 grid place-items-center">
                <Image src={LogoCut} alt="infinita logo" />
              </div>
              <div className="flex flex-col py-5 px-5 md:px-10 text-primary">
              ...
              <div className="flex flex-col py-5 px-10 md:text-left text-primary">
